...
Find an example DDL based VDB xref:dv-on-openshift.doc#YML_DDL[here].
...
Find an example DDL based VDB xref:dv-on-openshift.doc#YML_FATJAR[here].
...
Find an example DDL based VDB xref:dv-on-openshift.doc#YML_MAVEN[here].
