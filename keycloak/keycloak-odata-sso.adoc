...
----
http://security-example-odata-teiid-dataservice.192.168.99.100.nip.io/*
----
...
----
http://security-example-odata-teiid-dataservice.192.168.99.100.nip.io/odata/CustomerZip
----
